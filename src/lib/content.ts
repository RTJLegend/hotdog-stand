...
export const REVIEWS: Review[] = [
  ...
  { name: "Dana K.", source: "Google", date: "June 2026", rating: 4, title: "Great, gets busy", text: "Chili cheese is loaded properly — chili actually tastes like beef, not a can. Docked one star only because Friday at noon is a 15-minute line. Order ahead and you're golden." },
...
export const TIMELINE = [
  { year: "2016", title: "A cart and a dream", text: "Brothers Marcus and Daryl Webb park a used hot dog cart outside the Loop farmers market with one recipe: their grandfather's Chicago dog build." },
...
export const TEAM = [
  { name: "Marcus Webb", role: "Co-founder, Grill", text: "Ex-line cook. Believes a steamed bun is a precision instrument. Handles the char grill on weekends." },
  { name: "Daryl Webb", role: "Co-founder, Ops", text: "Runs catering and the books. Can load a cart for 200 guests in 40 minutes flat." },
...
export const FAQS = [
  ...
  { q: "Do I need to order ahead?", a: "No, walk-ups are always welcome. But Friday lunch runs a 10–15 minute line, so ordering ahead saves you the wait." },
